...
pub fn spawn_sys_widget() -> Window {
    ...
    let spacer_box = GtkBox::new(Orientation::Horizontal, 0);
    spacer_box.set_hexpand(true);
    spacer_box.set_valign(gtk4::Align::End);
    spacer_box.append(&spacer);
    spacer_box.append(&next_btn);

    outer.append(&spacer_box);
